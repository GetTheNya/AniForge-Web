  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t border-[var(--color-border-glass)] py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          <div className="flex items-center gap-2 text-xs text-[var(--color-text-muted)]">
            <span>AniForge Web {import.meta.env.VITE_APP_VERSION || 'v0.0.0-dev'} • {t('library.subtext')}</span>
            <span>•</span>
            <a
              href="https://github.com/GetTheNya/Aniforge-Web"
              target="_blank"
